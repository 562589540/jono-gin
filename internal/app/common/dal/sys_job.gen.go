...
func newSysJob(db *gorm.DB, opts ...gen.DOOption) sysJob {
	...
	_sysJob.ID = field.NewUint(tableName, "id")
	...
	_sysJob.MisfirePolicy = field.NewInt(tableName, "misfire_policy")
	_sysJob.Status = field.NewInt(tableName, "status")
	_sysJob.CreatedBy = field.NewUint(tableName, "created_by")
	_sysJob.UpdatedBy = field.NewUint(tableName, "updated_by")
...
func (s *sysJob) updateTableName(table string) *sysJob {
	...
	s.MisfirePolicy = field.NewInt(table, "misfire_policy")
	s.Status = field.NewInt(table, "status")
	s.CreatedBy = field.NewUint(table, "created_by")
	s.UpdatedBy = field.NewUint(table, "updated_by")
...
type ISysJobDo interface {
	...
	GetByID(id uint) (result model.SysJob, err error)
	DeleteByID(id uint) (rowsAffected int64, err error)
	DeleteByIDs(ids []uint) (rowsAffected int64, err error)
}

// SELECT * FROM @@table WHERE id=@id
func (s sysJobDo) GetByID(id uint) (result model.SysJob, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("SELECT * FROM sys_job WHERE id=? ")
...
func (s sysJobDo) DeleteByID(id uint) (rowsAffected int64, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("DELETE FROM sys_job WHERE id=? ")
...
func (s sysJobDo) DeleteByIDs(ids []uint) (rowsAffected int64, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, ids)
	generateSQL.WriteString("DELETE FROM sys_job WHERE id IN (?) ")
