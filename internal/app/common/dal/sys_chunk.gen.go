...
func newChunk(db *gorm.DB, opts ...gen.DOOption) chunk {
	...
	_chunk.Number = field.NewInt(tableName, "number")
	_chunk.Path = field.NewString(tableName, "path")
	_chunk.Size = field.NewInt64(tableName, "size")
	_chunk.Hash = field.NewString(tableName, "hash")
	_chunk.Status = field.NewInt8(tableName, "status")
...
type IChunkDo interface {
	...
	GetByID(id uint) (result model.Chunk, err error)
	DeleteByID(id uint) (rowsAffected int64, err error)
	DeleteByIDs(ids []uint) (rowsAffected int64, err error)
}

// SELECT * FROM @@table WHERE id=@id
func (c chunkDo) GetByID(id uint) (result model.Chunk, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("SELECT * FROM sys_chunk WHERE id=? ")
...
func (c chunkDo) DeleteByID(id uint) (rowsAffected int64, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("DELETE FROM sys_chunk WHERE id=? ")
...
func (c chunkDo) DeleteByIDs(ids []uint) (rowsAffected int64, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, ids)
	generateSQL.WriteString("DELETE FROM sys_chunk WHERE id IN (?) ")
