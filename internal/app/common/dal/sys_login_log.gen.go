...
func newLoginLog(db *gorm.DB, opts ...gen.DOOption) loginLog {
	...
	_loginLog.UserName = field.NewString(tableName, "user_name")
	_loginLog.Address = field.NewString(tableName, "address")
	_loginLog.Behavior = field.NewString(tableName, "behavior")
	_loginLog.Browser = field.NewString(tableName, "browser")
	_loginLog.Ip = field.NewString(tableName, "ip")
	_loginLog.Status = field.NewBool(tableName, "status")
	_loginLog.System = field.NewString(tableName, "system")
...
func (l *loginLog) fillFieldMap() {
	...
	l.fieldMap["behavior"] = l.Behavior
	l.fieldMap["browser"] = l.Browser
	l.fieldMap["ip"] = l.Ip
	l.fieldMap["status"] = l.Status
	l.fieldMap["system"] = l.System
...
type ILoginLogDo interface {
	...
	GetByID(id uint) (result model.LoginLog, err error)
	DeleteByID(id uint) (rowsAffected int64, err error)
	DeleteByIDs(ids []uint) (rowsAffected int64, err error)
}

// SELECT * FROM @@table WHERE id=@id
func (l loginLogDo) GetByID(id uint) (result model.LoginLog, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("SELECT * FROM sys_login_log WHERE id=? ")
...
func (l loginLogDo) DeleteByID(id uint) (rowsAffected int64, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("DELETE FROM sys_login_log WHERE id=? ")
...
func (l loginLogDo) DeleteByIDs(ids []uint) (rowsAffected int64, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, ids)
	generateSQL.WriteString("DELETE FROM sys_login_log WHERE id IN (?) ")
